...
WAYPOINTS = [[4.5,0],[4.5,3.165],[4.5+0.915*cos(pi*75/180),2.25+0.915*sin(pi*75/180)],[4.5+0.915*cos(pi*60/180),2.25+0.915*sin(pi*60/180)],
             [4.5+0.915*cos(pi*45/180),2.25+0.915*sin(pi*45/180)],[4.5+0.915*cos(pi*30/180),2.25+0.915*sin(pi*30/180)],[4.5+0.915*cos(pi*15/180),2.25+0.915*sin(pi*15/180)],
             [5.415,2.25],[4.5+0.915*cos(pi*15/180),2.25-0.915*sin(pi*15/180)],[4.5+0.915*cos(pi*30/180),2.25-0.915*sin(pi*30/180)],
             [4.5+0.915*cos(pi*45/180),2.25-0.915*sin(pi*45/180)],[4.5+0.915*cos(pi*60/180),2.25-0.915*sin(pi*60/180)],[4.5+0.915*cos(pi*75/180),2.25-0.915*sin(pi*75/180)],
             [4.5,1.335],[4.5-0.915*cos(pi*75/180),2.25-0.915*sin(pi*75/180)],[4.5-0.915*cos(pi*60/180),2.25-0.915*sin(pi*60/180)],
             [4.5-0.915*cos(pi*45/180),2.25-0.915*sin(pi*45/180)],[4.5-0.915*cos(pi*30/180),2.25-0.915*sin(pi*30/180)],[4.5-0.915*cos(pi*15/180),2.25-0.915*sin(pi*15/180)],
             [3.585,2.25],[4.5-0.915*cos(pi*15/180),2.25+0.915*sin(pi*15/180)],[4.5-0.915*cos(pi*30/180),2.25+0.915*sin(pi*30/180)],
             [4.5-0.915*cos(pi*45/180),2.25+0.915*sin(pi*45/180)],[4.5-0.915*cos(pi*60/180),2.25+0.915*sin(pi*60/180)],[4.5-0.915*cos(pi*75/180),2.25+0.915*sin(pi*75/180)],
             [4.5,3.165],[4.5,4.5],[0,4.5],[0,0.235],[1.65,0.235],[1.65,4.265],[0,4.265],[0,1.335],[0.55,1.335],[0.55,3.165],[0,3.165],[0,0],[9,0],[9,4.265],
             [7.35,4.265],[7.35,0.235],[9,0.235],[9,3.165],[8.45,3.165],[8.45,1.335],[9,1.335],[9,4.5],[4.5,4.5]]
